                    ...
                    <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
                        ...
                        <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
                            ...
                            <button onclick="showMenu1(true)"
                                ...
                                <svg id="icon1" class="transform transition-transform duration-300"
                            ...
                            <div id="menu1"
                                class="hidden flex justify-start flex-col w-full md:w-auto items-start pb-1">
                                <button
            ...
            <div class="flex flex-col flex-1">
                <header class="relative flex items-center justify-between flex-shrink-0 p-4">
                    ...
                    <div class="items-center hidden ml-4 sm:flex">
                        ...
                        <!-- User link -->
                        <div class="hidden sm:flex sm:items-center sm:ms-6 relative" x-data="{ isOpen: false }">
                            <button
                            ...
                            <div x-show="isOpen" @click.away="isOpen = false" @keydown.escape="isOpen = false"
                                x-ref="userMenu" tabindex="-1"
                                class="absolute w-48 py-1 mt-2 origin-bottom-left bg-white rounded-md shadow-lg right-0 top-12 focus:outline-none"
                                role="menu" aria-orientation="vertical" aria-label="user menu">

                                <div class="block px-4 py-2 text-sm text-gray-700 border-b-2">{{ Auth::user()->name }}
                                </div>
